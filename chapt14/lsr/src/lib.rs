...
/// return a string like "rwxr-x--x"
// my function
fn my_format_mode(mode: u32) -> String {
    let changemode = |mode: u32, mask: &[u32], result: &mut String| {
    ...
    let user_mask = vec![0o400, 0o200, 0o100];
    let group_mask = vec![0o040, 0o020, 0o010];
    let other_mask = vec![0o004,0o002,0o001];
    changemode(mode, &user_mask, &mut result);
    changemode(mode, &group_mask, &mut result);
    changemode(mode, &other_mask, &mut result);
    result
}
...
#[cfg(test)]
mod test {
    use super::{mk_triple, Owner, long_match, find_files, format_mode, format_output};
    ...
    fn test_octal() {
        ...
        assert_eq!((0o321 / 0o1 % 0o10), 0o1);
        assert_eq!((0o321 / 0o10 % 0o10) , 0o2);
        assert_eq!((0o321 / 0o100 % 0o10), 0o3);
        for n in 0..=7 {
            println!("{} = {:03b}", n, n);
        }
